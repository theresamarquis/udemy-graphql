...
const CompanyType = new GraphQLObjectType({
   name: 'Company',
   fields: ()=> ({  // JS closure scope returning an object
    ...
    fields: {
        user: {
            ...
            resolve(parentValue, args){
                ...
                // resolve has to return a JS object but this find works!!
                // future may need reduce?
               
                // const newObj = fetchUserData(args.id)
                // return newObj
